...
public class userControllerTest {
    ...
    void addUser(int count) throws Exception{
        ...
        for(int i = 0; i < count; i++) {
            UserInfo userInfo = new UserInfo(0L, nameBase+i, password, nameBase+i+"@test.com", "136914326"+(100+i));
    ...
    public void testModify() throws Exception{
        ...
        for (int i = 0; i < count; i++) {
            UserInfo userInfo = new UserInfo(0L, nameBase+i, "222222", nameBase+i+"@abc.com", "136914326"+(100+i));
            ObjectMapper mapper = new ObjectMapper();
